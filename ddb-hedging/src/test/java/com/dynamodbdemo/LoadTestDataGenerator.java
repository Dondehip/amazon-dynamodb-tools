...
public class LoadTestDataGenerator {
    ...
    public static final int NUMBER_OF_SUB_RECORDS = 100;

    public static final int NUMBER_OF_RECORDS_PER_FILE = 1000;
    public static final String DDB_TABLE_NAME = "hedging-demo-105";
    public static final int ENTITY_COUNT = 50;
    public static final String LOADTEST_ENTITY_RECORD_DATA_TEMPLATE_TXT = "loadtest/entity_record_data_template.txt";
    private static final boolean COMPRESS_UPLOAD = true;
    ...
    static String S3_KEY_PREFIX = "data-to-import/hedging-demo-105/";
    ...
    public static void main(String[] args) throws IOException {
        ...
        Scanner scanner = new Scanner(new File(LOADTEST_ENTITY_RECORD_DATA_TEMPLATE_TXT));
        while (scanner.hasNextLine()) {

            // Only read a single line
            templateRecord = scanner.nextLine();
        }
        scanner.close();

        for (int i=0; i< NUMBER_OF_SUB_RECORDS; i++){
            templateLines.add(templateRecord.replace("$SK_INDEX$", String.valueOf(i)));
        }
